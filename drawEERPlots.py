...
attributes = ["faceConfidence", "eye0Confidence", "eye1Confidence", "age", "chin", "crown", "deviationFromFrontalPose",
              "deviationFromUniformLighting", "ear0", "ear1", "ethnicityAsian", "ethnicityBlack", "ethnicityWhite",
              "exposure", "eye0X", "eye0Y", "eye0GazeFrontal", "eye0Open", "eye0Red", "eye0Tinted", "eye1X", "eye1Y",
              "eye1GazeFrontal", "eye1Open", "eye1Red", "eye1Tinted", "eyeDistance", "faceCenterX", "faceCenterY",
              "glasses", "grayScaleDensity", "height", "hotSpots", "isMale", "lengthOfHead", "mouthClosed",
              "naturalSkinColour", "numberOfFaces", "poseAngleRoll", "sharpness", "width", "widthOfHead"]
...
pool = Pool(20)
pool.map(calculate_eer, binary_attributes)
pool.close()
pool.join()
